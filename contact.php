...
<body>
  ...
  <div id="contactus">
    <table style="width:650px;">
      <tr>
        <td><img src="http://localhost/Event-web-portal-application/images/location.jpg" width="200px" height="150px"></td>
        <td><img src="http://localhost/Event-web-portal-application/images/phone.jpg" width="50px" height="50px"></td>
        <td><img src="http://localhost/Event-web-portal-application/images/mail.jpg" width="80px" height="80px"></td>
      </tr>
      <?php
